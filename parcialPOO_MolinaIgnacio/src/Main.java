...
public class Main {
    public static void main(String[] args) {
        ...
        Automovil a1 = new Automovil(d1,LocalDate.of(2022,1,25),50000.0,"Renault","ABC123",true,false,1100);
        ...
        //Validando metodo getEsNacional;
        System.out.println(c2.getEsNacional());

        //Validando metodo esEconomico;
        System.out.println(a1.esEconomico());
